...
public class Client  implements ActionListener{
    ...
    Client(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("Image/2.png"));
        ...
        JLabel name = new JLabel("Akash Bansal");
        name.setBounds(110,15,150,18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SEN_SERIF",Font.BOLD,18));
        p1.add(name);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        //these two lines align the message in right hand side
